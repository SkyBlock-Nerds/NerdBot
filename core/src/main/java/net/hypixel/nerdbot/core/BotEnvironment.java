...
import net.hypixel.nerdbot.core.util.UUIDUtils;
import net.hypixel.nerdbot.core.util.gson.adapter.BadgeTypeAdapter;
import net.hypixel.nerdbot.core.util.gson.adapter.InstantTypeAdapter;
import net.hypixel.nerdbot.core.util.gson.adapter.UUIDTypeAdapter;
