...
public class ReactionChannelListener {
    ...
    public void onMessageReceive(MessageReceivedEvent event) {
        List<ReactionChannel> reactionChannels = BotEnvironment.getBot().getConfig().getChannelConfig().getReactionChannels();
        ...
        String pollChannelId = BotEnvironment.getBot().getConfig().getChannelConfig().getPollChannelId();
