...
public class RoleRestrictedChannelListener {
    ...
    private RoleRestrictedChannelGroup findOrCreateRoleRestrictedGroup(BotConfig botConfig, Guild guild, Set<String> roleIds) {
        List<RoleRestrictedChannelGroup> groups = new ArrayList<>(botConfig.getChannelConfig().getRoleRestrictedChannelGroups());
    ...
    private boolean removeEmptyRoleRestrictedGroups(BotConfig botConfig) {
        List<RoleRestrictedChannelGroup> groups = new ArrayList<>(botConfig.getChannelConfig().getRoleRestrictedChannelGroups());
