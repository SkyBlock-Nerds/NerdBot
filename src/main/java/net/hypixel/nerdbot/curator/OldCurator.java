...
public class OldCurator {
     ...
     */
    public OldCurator(int limit, List<ChannelGroup> groups, boolean readOnly) {
        this.limit = limit;
        this.groups = groups;
     ...
     */
    public OldCurator(int limit, ChannelGroup group, boolean readOnly) {
