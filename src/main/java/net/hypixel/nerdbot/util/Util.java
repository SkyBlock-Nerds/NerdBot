...
public class Util {
    ...
    public static DiscordUser getOrAddUserToCache(MongoDatabase mongoDatabase, String userId) {
        DiscordUser discordUser = mongoDatabase.findDocument(mongoDatabase.getCollection("users", DiscordUser.class), "discordId", userId).first();
        if (discordUser == null) {
