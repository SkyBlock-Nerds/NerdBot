...
@Setter
@ToString
public class InventorySlot extends GeneratedObject {
    ...
    public InventorySlot(int overallSlot, int slotInRow, int row, ImageCoordinates imageCoordinates) {
        super(null);
    ...
    public InventorySlot(int overallSlot, int slotInRow, int row, ImageCoordinates imageCoordinates, BufferedImage image) {
        super(image);
        this.overallSlot = overallSlot;
        this.slotInRow = slotInRow;
        this.row = row;
