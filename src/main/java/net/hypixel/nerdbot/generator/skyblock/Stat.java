...
public enum Stat {
    ...
    CRIT_CHANCE("☣", "Crit Chance", ChatFormat.BLUE, ParseType.PERCENT_SYMBOL),
    CRIT_DAMAGE("☠", "Crit Damage", ChatFormat.BLUE, ParseType.PERCENT_SYMBOL),
    ATTACK_SPEED("⚔", "Bonus Attack Speed", ChatFormat.YELLOW, ChatFormat.GREEN, ParseType.PERCENT_SYMBOL),
    ...
    SEA_CREATURE_CHANCE("α", "Sea Creature Chance", ChatFormat.DARK_AQUA, null, ParseType.BOLD_ICON), // TODO support percent symbol parse type here
    FISHING_SPEED("☂", "Fishing Speed", ChatFormat.AQUA),
    ABILITY_DAMAGE("๑", "Ability Damage", ChatFormat.RED, ParseType.PERCENT_SYMBOL),
