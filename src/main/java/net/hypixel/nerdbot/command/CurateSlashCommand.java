...
public class CurateSlashCommand extends ApplicationCommand {
    ...
    public void curate(GuildSlashEvent event, ForumChannel forumChannel, @AppOption(description = "Run the curator without greenlighting suggestions") boolean readOnly) {
